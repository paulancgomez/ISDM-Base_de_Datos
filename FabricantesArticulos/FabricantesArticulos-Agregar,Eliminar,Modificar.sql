...
-- 22.- Aplicar un descuento de $50 a todos los artículos cuy precio se superior a $800
UPDATE articulos SET precio = precio - 50.00 WHERE precio > 800.00; -- ??????
SELECT * FROM articulos;

-- 23.- Agregar un nuevo para el fabricante LENOVO
INSERT INTO articulos (nombre, precio, fabricante) VALUES
('COMPUTADORA', 23000, SELECT codigo FROM fabricantes WHERE nombre = 'LENOVO'); -- QUE HAGO ACA????