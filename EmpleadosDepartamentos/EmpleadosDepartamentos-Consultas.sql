...
SELECT * FROM empleados WHERE apellidos = 'CORTES' OR apellidos = 'PEREZ';
SELECT * FROM empleados WHERE apellidos IN ('CORTES', 'PEREZ');
...
SELECT * FROM empleados WHERE departamento = 7 OR departamento = 11;
SELECT * FROM empleados WHERE departamento IN (7, 11);
