...
SELECT codigo, nombre, precio FROM articulos WHERE precio < 250;

-- 4.- Mostrar los productos cuyo precio oscile entre los $250 y $1000
SELECT codigo, nombre, precio FROM articulos WHERE precio BETWEEN 250 AND 1000; -- Con BETWEEN
SELECT codigo, nombre, precio FROM articulos WHERE precio >= 250 AND precio <= 1000; -- Con AND
...
SELECT COUNT(*) AS CANT_ARTICULOS FROM articulos WHERE precio < 750;

-- 8.- Obtener el precio promedio de los artículos provistos por el fabricante 5
SELECT AVG(precio) AS PRECIO_MEDIO FROM articulos WHERE fabricante = 5;
